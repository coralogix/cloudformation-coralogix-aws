...
|------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------|--------------------|
| S3ConfigBucket   | S3 bucket containing collector and optional Supervisor configurations. Required in collector mode.                                                                                                                                   | ""                                                                       | collector mode     |
...
`InitialFallbackConfigs` is a list of strings. In CloudFormation parameter overrides, write multiple URLs as one comma-separated value with no spaces. For example:
