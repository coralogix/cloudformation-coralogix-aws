...
- [Update] `CoralogixRegion` now accepts the region codes `EU1`, `EU2`, `AP1`, `AP2`, `AP3`, `US1`, `US2`, adding `AP3` and `US2` support. The former names (`Europe`, `Europe2`, `India`, `Singapore`, `US`) are still accepted and map to the same endpoints.
