...
| CoralogixRegion     | The Coralogix location region: `EU1`, `EU2`, `AP1`, `AP2`, `AP3`, `US1`, `US2`, `US3`. The former names (`Europe`, `Europe2`, `India`, `Singapore`, `US`) are still accepted. | String |                                        | ✔️        |
